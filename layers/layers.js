...
lyr_AREA_FUNGSIONAL_4.set('fieldAliases', {'Id': 'Id', 'LUAS_HA': 'LUAS_HA', 'KET_2': 'KET_2', 'LUAS': 'LUAS', });
...
lyr_AREA_FUNGSIONAL_4.set('fieldImages', {'Id': 'Range', 'LUAS_HA': 'TextEdit', 'KET_2': 'TextEdit', 'LUAS': '', });
...
lyr_AREA_FUNGSIONAL_4.set('fieldLabels', {'Id': 'hidden field', 'LUAS_HA': 'hidden field', 'KET_2': 'hidden field', 'LUAS': 'inline label - visible with data', });
...
lyr_Gorong__Gorong_8.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - always visible', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
